...
# first image
        img=Image.open(r"C:\Users\HRYADAV\Desktop\attendence system\images\studenthead.jpg")
    ...
    #Background image
        ...
        main_frame.place(x=6,y=22,width=1349,height=560)

    #left side label frame
        Left_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=8,y=10,width=660,height=535)

        img_left=Image.open(r"C:\Users\HRYADAV\Desktop\attendence system\images\details.jpg")
    ...
    #current course information
        ...
        current_course_frame.place(x=4,y=105,width=649,height=110)
    ...
    #Department
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT","civil","science","Art")
        dep_combo.current(0)
    ...
    #Class student information
        ...
        class_Student_frame.place(x=4,y=215,width=649,height=295)
    ...
    #buttons frame1
        ...
        btn_frame.place(x=0,y=198,width=645,height=37)#-----------Yahabn change karna hai----------
    ...
    #button frame2
        ...
        btn_frame1.place(x=0,y=235,width=645,height=37)
    ...
    #Right side label frame
        ...
        Right_frame.place(x=675,y=10,width=660,height=535)

        img_right=Image.open(r"C:\Users\HRYADAV\Desktop\attendence system\images\details.jpg")
    ...
    #Search system
        Search_frame=LabelFrame(Right_frame,bd=2,relief=RIDGE,text="Search System information",font=("times new roman",12,"bold"))
        Search_frame.place(x=4,y=105,width=649,height=85)

        search_label=Label(Search_frame,text="Search By :",font=("times new roman",13,"bold"),fg="GREEN")
    ...
    #Table Frame]
        ...
        table_frame.place(x=4,y=192, width=649,height=320)
    ...
    #Functio Declearation for adding data
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="sanjay",database="face_recognizer")
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Student detailshas been added succefully",parent=self.root)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    ...
                    if not Upadate:
                        return
                messagebox.showinfo("Success","Student details succrssfully update completed",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating data set complited !!!")
            except Exception as es:
                messagebox.showerror("Error",f"Due to :{str(es)}",parent=self.root)
